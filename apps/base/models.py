...
class Categoria(ModeloBase):
    ...
    imagen = models.ImageField('Imagen Referencial', upload_to = 'categoria')
...
class Post(ModeloBase):
    titulo = models.CharField('Titulo del Post', max_length = 100, unique = True)
    ...
    fecha_de_publicacion = models.DateField('Fecha de Publicación') 
