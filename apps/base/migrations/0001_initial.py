    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagen', models.ImageField(upload_to='categoria', verbose_name='Imagen Referencial')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_modificacion', models.DateField(auto_now=True, verbose_name='Fecha de Modificación')),
                ('fecha_eliminacion', models.DateField(auto_now=True, verbose_name='Fecha de Eliminación')),
                ('titulo', models.CharField(max_length=100, unique=True, verbose_name='Titulo del Post')),
                ...
                ('fecha_de_publicacion', models.DateField(verbose_name='Fecha de Publicación')),
